...
def help_txt(f, sc):
    ...
    help_text2 = f.render('Зажмите кнопку ColorChoose', True, black)
    help_text3 = f.render('и нажимайте на клавиши', True, black)
    help_text4 = f.render('1 - Красный, 2 - Зелёный', True, black)
    help_text5 = f.render('3 - Синий, 0 - Чёрный', True, black)
    help_text6 = f.render('Для изменения размера кисти', True, black)
